...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/01/13 15:07:43 by saxiao            #+#    #+#             */
/*   Updated: 2020/01/13 17:01:03 by saxiao           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		is_fat_file(unsigned int magic)
{
	...
	magic == FAT_CIGAM_64 || magic == FAT_MAGIC_64);
}
...
int		is_hostarch(char *array, int should_swap_arch)
{
	...
	type = should_swap_arch ? swap_uint32(*(cpu_type_t *)\
	array) : *(cpu_type_t *)array;
